...
library(dplyr); library(reticulate); library(quantmod); library(eventdataR); library(RColorBrewer);library(devtools)
...
### Set file path
original <- read.csv("D:/HYEM'S/GraduatedSchool/PROJECTS/MyProjects/ProcessMining_PISA2012/datasets_after/1030_19_logdata_cluster3.csv",
...
df_D <- original[!is.na(original$cluster),]
df_D
